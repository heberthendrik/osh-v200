										...
										<header class="card-header bg-primary">
											...
											<div class="widget-profile-info">
												<div class="profile-picture">
													<img src="<?php echo $repository_url;?>/img/!logged-user.jpg">
												</div>
												...
												<li>
													<div class="tm-box">
														...
														<div class="thumbnail-gallery">
															<a class="img-thumbnail lightbox" href="<?php echo $repository_url;?>/img/projects/project-4.jpg" data-plugin-options='{ "type":"image" }'>
																<img class="img-fluid" width="215" src="<?php echo $repository_url;?>/img/projects/project-4.jpg">
																<span class="zoom">
