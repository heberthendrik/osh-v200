											...
											<footer class="card-footer">
												<div class="row">
													<div class="col-md-12 text-right">
														<a href="process.php?module=DeletePetugas&id=<?php echo $current_id ?>" class="btn btn-danger ">Confirm</a>
								...
								<section class="card">
									...
									<div class="card-body">
										...
										<div class="form-group row">
											...
											<div class="col-lg-6">
												<input type="text" class="form-control" id="input_namapetugas" name="textNama" value="<?php echo rtrim($function_GetPetugasByID['NAMA'][0]);?>" required >
											</div>
										</div>
										...
										<div class="form-group row">
											...
											<div class="col-lg-6">
												<input type="text" class="form-control" id="input_namapetugas" name="textKode" value="<?php echo rtrim($function_GetPetugasByID['KODE'][0]);?>" required >
											</div>
										</div>
