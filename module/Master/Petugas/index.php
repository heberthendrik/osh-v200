										...
										<table class="table table-bordered table-striped mb-0" id="datatable-default">
											...
											<tbody>
												...
												for( $i=0;$i<$function_GetAllPetugas['TOTAL_ROW'];$i++ ){
													...
													$input_parameter_rs['ID'] = $function_GetAllPetugas['ID_RS'][$i];
													$function_GetRumahSakitByID = GetRumahSakitByID($input_parameter_rs);
													
													?>
													<tr onclick="window.location='detail.php?id=<?php echo $function_GetAllPetugas['ID'][$i] ;?>'">
														<td><?php echo ($i+1);?></td>
														<td><?php echo $function_GetAllPetugas['NAMA'][$i];?></td>
														<td><?php echo $function_GetAllPetugas['STATUS'][$i];?></td>
														<td><?php echo $function_GetAllPetugas['KODE'][$i];?></td>
