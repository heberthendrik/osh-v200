...
$current_id = $_GET['id'];
$rumahsakit_parameter['ID'] = $current_id;
$function_GetRumahSakitByID = GetRumahSakitByID($rumahsakit_parameter);
?>
<!doctype html>
			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body card-margin">
											...
											<footer class="card-footer">
												<div class="row">
													<div class="col-md-12 text-right">
														<a href="process.php?module=DeleteRumahSakit&id=<?php echo $current_id ?>" class="btn btn-danger ">Confirm</a>
								...
								<section class="card">
									...
									<div class="card-body">
										...
										<div class="form-group row">
											...
											<div class="col-lg-6">
												<input type="text" class="form-control" id="input_namarumahsakit" name="textNama" value="<?php echo $function_GetRumahSakitByID['NAMA'][0]; ?>" required >
											</div>
										</div>
										...
										<div class="form-group row">
											...
											<div class="col-lg-6">
												<input type="text" class="form-control" id="input_namarumahsakit" name="textLink" value="<?php echo $function_GetRumahSakitByID['LINK'][0]; ?>" required >
											</div>
										</div>
										...
										<div class="form-group row">
											...
											<div class="col-lg-6">
												<?php
												if( trim($function_GetRumahSakitByID['LOGO'][0]) != '' && strlen($function_GetRumahSakitByID['LOGO'][0]) > 0 ){
													?>
													<img src="../../../media_library/logors/<?php echo $current_id;?>/<?php echo $function_GetRumahSakitByID['LOGO'][0]; ?>" style="max-width:400px;height:auto;" />
													<div style="padding-top:20px;"><a class="btn btn-danger" href="process.php?module=DeleteLogo&id=<?php echo $current_id;?>">Delete Logo</a></div>
													<?php
												} else {
													?>
													<input type="file" class="form-control" id="input_namarumahsakit" name="fileImage" required >
													<br/>File harus berekstensi .jpg, .jpeg, .png, .bmp dan tidak lebih dari 5 Mb.</div>	
													<?php
												}
												?>
					...
					<!-- end: page -->
						...
						<input type="hidden" name="module" value="UpdateRumahSakit" />
