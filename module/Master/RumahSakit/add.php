			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body card-margin">
								...
								<section class="card">
									...
									<div class="card-body">
										...
										<div class="form-group row">
											...
											<div class="col-lg-6">
												<input type="text" class="form-control" id="input_namarumahsakit" name="textNama" required >
											</div>
										</div>
										...
										<div class="form-group row">
											...
											<div class="col-lg-6">
												<input type="text" class="form-control" id="input_namarumahsakit" name="textLink" required >
											</div>
										</div>
					...
					<!-- end: page -->
						...
						<input type="hidden" name="module" value="AddRumahSakit" />
					</form>
				</section>
			</div>
