								...
								<section class="card">
									...
									<div class="card-body">
										<table class="table table-bordered table-striped mb-0" id="datatable-default">
											...
											<tbody>
												<?php
												$function_GetAllBarang = GetAllBarang();
												
												for( $i=0;$i<$function_GetAllBarang['TOTAL_ROW'];$i++ ){
													...
													?>
													<tr onclick="window.location='detail.php?id=<?php echo $function_GetAllBarang['ID'][$i] ;?>'">
														<td><?php echo ($i+1);?></td>
														<td><?php echo $function_GetAllBarang['NAME'][$i];?></td>
														<td><?php echo $function_GetAllBarang['KATALOG'][$i];?></td>
														<td><?php echo $function_GetKategoriByID['NAMA'][0];?></td>
														<td><?php echo $function_GetAllBarang['STATUS'][$i];?></td>
