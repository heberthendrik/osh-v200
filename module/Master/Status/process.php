...
if( $_POST['module'] == "UpdateStatus" ){
	...
	$function_result = UpdateStatusByID($input_parameter);
...
if( $_GET['module'] == "DeleteStatus" ){
	
	$input_parameter['ID'] = $_GET['id'];
	
	$function_result = DeleteStatusByID($input_parameter);
