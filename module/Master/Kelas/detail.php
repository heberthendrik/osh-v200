...
$current_id = $_GET['id'];
$kelas_parameter['ID'] = $current_id;
$function_GetKelasByID = GetKelasByID($kelas_parameter);
?>
<!doctype html>
			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body card-margin">
											...
											<footer class="card-footer">
												<div class="row">
													<div class="col-md-12 text-right">
														<a href="process.php?module=DeleteKelas&id=<?php echo $current_id ?>" class="btn btn-danger ">Confirm</a>
								...
								<section class="card">
									...
									<div class="card-body">
										...
										<div class="form-group row">
											<label class="col-lg-3 control-label text-lg-right pt-2" for="inputDefault">Nama Kelas *</label>
											<div class="col-lg-6">
												<input type="text" class="form-control" id="input_namakelas" name="textNama" value="<?php echo rtrim($function_GetKelasByID['NAMA'][0]);?>" required >
											</div>
										</div>
										...
										<div class="form-group row">
											...
											<div class="col-lg-6">
												<select class="form-control mb-3" id="input_status" name="selectStatus" required >
													<option value="0" <?php if( $function_GetKelasByID['STATUS'][0] == 0 ){ echo ' selected '; } ?> >Tidak Aktif</option>
													<option value="1" <?php if( $function_GetKelasByID['STATUS'][0] == 1 ){ echo ' selected '; } ?> >Aktif</option>
												</select>
											</div>
										</div>
											...
											<div class="col-lg-6">
												<select class="form-control mb-3" id="input_idrs" name="selectRumahSakit" required >
													...
													for( $i=0;$i<$function_GetAllRumahSakit['TOTAL_ROW'];$i++ ){
														...
														if( $function_GetAllRumahSakit['ID'][$i] == $function_GetKelasByID['ID_RS'][0] ){
					...
					<!-- end: page -->
						...
						<input type="hidden" name="module" value="UpdateKelas" />
