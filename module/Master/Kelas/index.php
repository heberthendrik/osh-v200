										...
										<table class="table table-bordered table-striped mb-0" id="datatable-default">
											...
											<tbody>
												...
												for( $i=0;$i<$function_GetAllKelas['TOTAL_ROW'];$i++ ){
													...
													$input_parameter_rs['ID'] = $function_GetAllKelas['ID_RS'][$i];
													$function_GetRumahSakitByID = GetRumahSakitByID($input_parameter_rs);
													
													?>
													<tr onclick="window.location='detail.php?id=<?php echo $function_GetAllKelas['ID'][$i] ;?>'">
														<td><?php echo ($i+1);?></td>
														<td><?php echo $function_GetAllKelas['NAMA'][$i];?></td>
														<td><?php echo $function_GetAllKelas['STATUS'][$i];?></td>
