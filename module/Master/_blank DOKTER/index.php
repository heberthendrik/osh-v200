...
<html class="fixed sidebar-light sidebar-left-collapsed">
	<head>
		...
		<title>Advanced Tables | Porto Admin - Responsive HTML5 Template 2.1.1</title>
										...
										<table class="table table-bordered table-striped mb-0" id="datatable-default">
											...
											<tbody>
												...
												for( $i=0;$i<$function_GetAllDokter['TOTAL_ROW'];$i++ ){
													...
													$input_parameter_rs['ID'] = $function_GetAllDokter['ID_RS'][$i];
													$function_GetRumahSakitByID = GetRumahSakitByID($input_parameter_rs);
													
													?>
													<tr onclick="window.location='detail.php?id=<?php echo $function_GetAllDokter['ID'][$i] ;?>'">
														<td><?php echo ($i+1);?></td>
														<td><?php echo $function_GetAllDokter['NAMA'][$i];?></td>
														<td><?php echo $function_GetAllDokter['STATUS'][$i];?></td>
														<td><?php echo $function_GetAllDokter['KODE'][$i];?></td>
