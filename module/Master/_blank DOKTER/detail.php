...
$current_id = $_GET['id'];
$dokter_parameter['ID'] = $current_id;
$function_GetDokterByID = GetDokterByID($dokter_parameter);
?>
<!doctype html>
<html class="fixed sidebar-light sidebar-left-collapsed">
	<head>
		...
		<title>Basic Forms | Porto Admin - Responsive HTML5 Template 2.1.1</title>
			...
			<header class="header">
				<div class="logo-container">
					<a href="../2.1.1" class="logo">
						<img src="<?php echo $repository_url;?>/img/logo.png" width="75" height="35" alt="Porto Admin" />
					</a>
									...
									<ul>
										<li>
											<a href="#" class="clearfix">
												<figure class="image">
													<img src="<?php echo $repository_url;?>/img/!sample-user.jpg" alt="Joseph Doe Junior" class="rounded-circle" />
												</figure>
										...
										<li>
											<a href="#" class="clearfix">
												<figure class="image">
													<img src="<?php echo $repository_url;?>/img/!sample-user.jpg" alt="Joseph Junior" class="rounded-circle" />
												</figure>
										...
										<li>
											<a href="#" class="clearfix">
												<figure class="image">
													<img src="<?php echo $repository_url;?>/img/!sample-user.jpg" alt="Joe Junior" class="rounded-circle" />
												</figure>
					...
					<div id="userbox" class="userbox">
						<a href="#" data-toggle="dropdown">
							<figure class="profile-picture">
								<img src="<?php echo $repository_url;?>/img/!logged-user.jpg" alt="Joseph Doe" class="rounded-circle" data-lock-picture="<?php echo $repository_url;?>/img/!logged-user.jpg" />
							</figure>
			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body card-margin">
											...
											<footer class="card-footer">
												<div class="row">
													<div class="col-md-12 text-right">
														<a href="process.php?module=DeleteDokter&id=<?php echo $current_id ?>" class="btn btn-danger ">Confirm</a>
								...
								<section class="card">
									...
									<div class="card-body">
										...
										<div class="form-group row">
											...
											<div class="col-lg-6">
												<input type="text" class="form-control" id="input_namadokter" name="textNama" value="<?php echo rtrim($function_GetDokterByID['NAMA'][0]);?>" required >
											</div>
										</div>
										...
										<div class="form-group row">
											...
											<div class="col-lg-6">
												<input type="text" class="form-control" id="input_namadokter" name="textKode" value="<?php echo rtrim($function_GetDokterByID['KODE'][0]);?>" required >
											</div>
										</div>
					...
					<!-- end: page -->
						...
						<input type="hidden" name="module" value="UpdateDokter" />
