...
$current_id = $_GET['id'];
$pasien_parameter['ID'] = $current_id;
$function_GetPasienByID = GetPasienByID($pasien_parameter);
?>
<!doctype html>
			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body card-margin">
											...
											<footer class="card-footer">
												<div class="row">
													<div class="col-md-12 text-right">
														<a href="process.php?module=DeletePasien&id=<?php echo $current_id ?>" class="btn btn-danger ">Confirm</a>
								...
								<section class="card">
									...
									<div class="card-body">
										...
										<div class="form-group row">
											...
											<div class="col-lg-6">
												<input type="text" class="form-control" id="input_namapasien" name="textNama" required value="<?php echo rtrim($function_GetPasienByID['NAMA'][0]);?>" >
											</div>
										</div>
										...
										<div class="form-group row">
											...
											<div class="col-lg-6">
												<select class="form-control " id="input_status" name="selectSex" required >
													...
													<option value="P" <?php if( $function_GetPasienByID['SEX'][0] == "P" ){ echo ' selected ';} ?>  >Perempuan</option>
												</select>
											</div>
										</div>
										...
										<div class="form-group row">
											...
											<div class="col-lg-6">
												<select class="form-control " id="input_status" name="selectStatus" required >
													<option value="0" <?php if( $function_GetPasienByID['STATUS'][0] == 0 ){ echo ' selected ';} ?> >Tidak Aktif</option>
													<option value="1" <?php if( $function_GetPasienByID['STATUS'][0] == 1 ){ echo ' selected ';} ?> >Aktif</option>
												</select>
											</div>
										</div>
												...
												<div class="col-lg-6">
													<select class="form-control " id="input_idrs" name="selectRumahSakit" required >
														...
														for( $i=0;$i<$function_GetAllRumahSakit['TOTAL_ROW'];$i++ ){
															...
															if( $function_GetAllRumahSakit['ID'][$i] == $function_GetPasienByID['ID_RS'][0] ){
								...
								<section class="card">
									...
									<div class="card-body">
										...
										<div class="form-group row">
											...
											<div class="col-lg-6">
												<input type="text" class="form-control" id="input_namapasien" name="textAlamat" required value="<?php echo rtrim($function_GetPasienByID['ALAMAT'][0]);?>" >
											</div>
										</div>
										...
										<div class="form-group row">
											...
											<div class="col-lg-6">
												<input type="date" class="form-control" id="input_namapasien" name="dateTanggalLahir" value="<?php echo rtrim($function_GetPasienByID['TGL_LAHIR'][0]);?>" required >
											</div>
										</div>
					...
					<!-- end: page -->
						...
						<input type="hidden" name="module" value="UpdatePasien" />
