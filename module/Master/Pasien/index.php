								...
								<section class="card">
									...
									<div class="card-body">
										<table class="table table-bordered table-striped mb-0" id="datatable-default">
											...
											<tbody>
												<?php
												$function_GetAllPasien = GetAllPasien();
												
												for( $i=0;$i<$function_GetAllPasien['TOTAL_ROW'];$i++ ){
													
													$input_parameter_rs['ID'] = $function_GetAllPasien['ID_RS'][$i];
													$function_GetRumahSakitByID = GetRumahSakitByID($input_parameter_rs);
													
													?>
													<tr onclick="window.location='detail.php?id=<?php echo $function_GetAllPasien['ID'][$i] ;?>'">
														<td><?php echo ($i+1);?></td>
														<td><?php echo $function_GetAllPasien['NAMA'][$i];?></td>
														<td><?php echo $function_GetAllPasien['ALAMAT'][$i];?></td>
														<td><?php echo $function_GetAllPasien['NO_RM'][$i];?></td>
